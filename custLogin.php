...
<head>
    ...
    <title>Customer Login - Sentiment Analysis</title>
    ...
    <style>
        ...
        * {
        ...
        /* Quote Section */
        .quote {
            width: 50%; /* Align with login form */
            padding: 30px;
...
">
    <?php echo htmlspecialchars($_GET['error']); ?>
        ...
        <form action="custProclogin.php" method="POST">
        ...
        <div class="signup-message">
            <p>Don't have an account? <a href="custSignup.php" class="signup-link">Sign Up</a></p>
        </div>
    </div>
</div>
